...
export class PoseSolver {
    ...
    static solve(
        ...
        const rightHandOffscreen = lm3d[15].y > 1.0 || (lm3d[15].visibility ?? 0) < 0.70// || 0.995 < lm2d[15].y;
        const leftHandOffscreen = lm3d[16].y > 1.0 || (lm3d[16].visibility ?? 0) < 0.70// || 0.995 < lm2d[16].y;
